...
module.exports = {
    name: 'link-solat',
    description: 'Generate link solat dan mengirimkannya ke inbox anda',
    usage:'|link-solat <NIS>',
    example: '|link-solat 110237203',
    execute(Discord, message, args){
        ...
        .setTitle(`Link absen solat`)
        .setAuthor('PencatatSolat', 'https://i.kym-cdn.com/photos/images/original/001/464/390/36d.jpg')
        .setDescription(`Link anda:`)
        .setColor('RANDOM')

        type.forEach((item) => {
            embed.addField(`${item}`, `https://docs.google.com/forms/d/e/1FAIpQLSeqtFLIyOr3e7tvmWTzEiRCvzvplieNAIZ6vFhPK-0phaCVFQ/viewform?entry.965509794=${nis}&entry.644467975=${item}&entry.864545567=${year}-${month}-${date}`, false);
        })
